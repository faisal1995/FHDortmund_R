...
exp <- exp %>% mutate(d = abs( Gold - Gold.1) / Gold.2)
exp$Country[which.max(exp$d)]
...
q6 <- aggregate(census_df$CENSUS2010POP, by=list(STATES=census_df$STNAME), FUN=sum)
q6 <- arrange(q6,q6$x)
...
```{r}
 q7 <- census_df %>% select(4,6,10:15)
 #q7 <- q7 %>% rowwise() %>% mutate(Min = min(q7$POPESTIMATE2010, q7$POPESTIMATE2011, q7$POPESTIMATE2012,q7$POPESTIMATE2013,q7$POPESTIMATE2014))
 
 # q7 <- q7 %>% rowwise() %>% mutate(max = max(q7$POPESTIMATE2010, q7$POPESTIMATE2011, q7$POPESTIMATE2012,q7$POPESTIMATE2013,q7$POPESTIMATE2014))
